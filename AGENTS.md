...
- `/src`: This is where the code that makes up  gdsis located
- `/lib`: This holds the code for the bstring library
- `/etc`: This holds the configuration information
- `/doc`: This holds all of the man pages
...
work consistently within the pads repository.
